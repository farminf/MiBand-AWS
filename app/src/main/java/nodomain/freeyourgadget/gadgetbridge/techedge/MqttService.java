...
//
//    private static final String MQTT_BROKER = "A13X5C2WK2YILQ.iot.us-east-1.amazonaws.com"; // Broker URL or IP Address
//    private static final int MQTT_PORT = 8883; // Broker Port
//
...
//
//                    //mClient.subscribe("$aws/things/band1/shadow/update", 0);
//
